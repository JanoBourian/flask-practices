...
class Item(Resource):
    ...
    parser.add_argument(
        ...
        type = str,
        required = True, 
        help = "sku field is necessary")
    parser.add_argument(
        'price',
        type = float,
        required = True, 
        help = "price field is necessary")
    parser.add_argument(
        'store_id',
        type = int,
        required = True, 
        help = "store_id field is necessary")
    ...
    def post(self, name): 
        ...
        try:
            ...
            item = ItemModel(sku = data["sku"], name = name, price = data["price"], store_id = data["store_id"])
